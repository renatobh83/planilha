export const calculo = async (capital, payout) => {
  try {
    const valorEntrada = async () => {
      const capitalInicial = await ((parseFloat(capital) * 0.77) / 100).toFixed(
        2
      );
    ...
    const prejuizoGale1 = async () => {
      const result = (
        parseFloat(valor) + parseFloat(resultadoMartinGale1)
      ).toFixed(2);
      return result;
    };
    const martingale2 = () => {
      const result = (
        ((parseFloat(valor) + parseFloat(resultadoMartinGale1)) / payout) *
        100
      ).toFixed(2);
      return result;
    };
    ...
    const prejuizoGale2 = async () => {
      const result = (
        parseFloat(valor) +
        parseFloat(resultadoMartinGale1) +
        parseFloat(resultadoMartinGale2)
      ).toFixed(2);
      return result;
    };
    const [
